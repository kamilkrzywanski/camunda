 ...
 *
 * <p>Authentication uses the AWS SDK default credentials provider chain (e.g. IRSA/STS web-identity,
 * instance profile, environment variables, system properties). This config does not accept explicit
 * credentials fields.
 *
